...
class RawDataViewLocations(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataViewId", "viewType", "rawDataType", "dataItems", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataViewId", "viewType", "rawDataType", "dataItems", ], str]):
