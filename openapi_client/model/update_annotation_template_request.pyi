...
class UpdateAnnotationTemplateRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "id", "description", "labels", "wordList", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "id", "description", "labels", "wordList", ], str]):
