...
SchemaFor200ResponseBodyApplicationJson = ArtifactLocations
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_artifact_locations_in_data_view_oapg(
        self,
...
class GetArtifactLocationsInDataView(BaseApi):
    ...
    def get_artifact_locations_in_data_view(
        ...
        return self._get_artifact_locations_in_data_view_oapg(
