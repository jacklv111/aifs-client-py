...
# body param
SchemaForRequestBodyApplicationJson = FilterAnnotationsInDataViewRequest


request_body_filter_annotations_in_data_view_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FilterAnnotationsInDataViewResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _filter_annotations_in_data_view_oapg(
        self,
    ...
    def _filter_annotations_in_data_view_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_filter_annotations_in_data_view_request.serialize(body, content_type)
...
class FilterAnnotationsInDataView(BaseApi):
    ...
    def filter_annotations_in_data_view(
        ...
        return self._filter_annotations_in_data_view_oapg(
            body=body,
