...
# body param
SchemaForRequestBodyApplicationJson = UpdateDatasetZipRequest


request_body_update_dataset_zip_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_dataset_zip_view_oapg(
        self,
    ...
    def _update_dataset_zip_view_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_dataset_zip_request.serialize(body, content_type)
...
class UpdateDatasetZipView(BaseApi):
    ...
    def update_dataset_zip_view(
        ...
        return self._update_dataset_zip_view_oapg(
            body=body,
