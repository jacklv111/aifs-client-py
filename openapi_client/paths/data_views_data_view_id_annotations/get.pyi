...
LabelIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'labelId': typing.Union[LabelIdSchema, str, uuid.UUID, ],
    },
    total=False
)
...
request_query_label_id = api_client.QueryParameter(
    name="labelId",
    style=api_client.ParameterStyle.FORM,
...
class SchemaFor200ResponseBodyApplicationJson(
        ...
        class properties:
            ...
            class annotationList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AnnotationListItem']:
                        return AnnotationListItem
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AnnotationListItem'], typing.List['AnnotationListItem']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'annotationList':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AnnotationListItem':
                    return super().__getitem__(i)
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["annotationList"]) -> MetaOapg.properties.annotationList: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["annotationTemplateId", "annotationTemplateType", "annotationList", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["annotationList"]) -> typing.Union[MetaOapg.properties.annotationList, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["annotationTemplateId", "annotationTemplateType", "annotationList", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        annotationList: typing.Union[MetaOapg.properties.annotationList, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_annotations_in_data_view_oapg(
        self,
...
class GetAnnotationsInDataView(BaseApi):
    ...
    def get_annotations_in_data_view(
        ...
        return self._get_annotations_in_data_view_oapg(
