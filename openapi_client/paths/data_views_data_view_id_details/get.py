...
SchemaFor200ResponseBodyApplicationJson = DataViewDetails
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_data_view_details_oapg(
        self,
...
class GetDataViewDetails(BaseApi):
    ...
    def get_data_view_details(
        ...
        return self._get_data_view_details_oapg(
