...
SchemaFor200ResponseBodyApplicationJson = DatasetZipLocation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_dataset_zip_location_in_data_view_oapg(
        self,
...
class GetDatasetZipLocationInDataView(BaseApi):
    ...
    def get_dataset_zip_location_in_data_view(
        ...
        return self._get_dataset_zip_location_in_data_view_oapg(
