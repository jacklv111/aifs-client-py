...
class AnnotationTemplateTypeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_anno_template_type_list_endpoint = _Endpoint(
            settings={
                'response_type': (AnnotationTemplateTypeList,),
                'auth': [],
                'endpoint_path': '/annotation-template-types',
                'operation_id': 'get_anno_template_type_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_anno_template_type_list(
        self,
        **kwargs
    ):
        """Get annotation template type list  # noqa: E501

        Get annotation template type list  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_anno_template_type_list(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_anno_template_type_list_endpoint.call_with_http_info(**kwargs)
