...
# body param
SchemaForRequestBodyApplicationJson = DivideRawDataDataViewRequest


request_body_divide_raw_data_data_view_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DivideRawDataDataViewResponse
...
class BaseApi(api_client.Api):
    ...
    def _divide_data_view_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_divide_raw_data_data_view_request.serialize(body, content_type)
...
class DivideDataView(BaseApi):
    ...
    def divide_data_view(
        ...
        return self._divide_data_view_oapg(
            body=body,
