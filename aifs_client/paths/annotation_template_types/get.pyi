...
SchemaFor200ResponseBodyApplicationJson = AnnotationTemplateTypeList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_anno_template_type_list_oapg(
        self,
...
class GetAnnoTemplateTypeList(BaseApi):
    ...
    def get_anno_template_type_list(
        ...
        return self._get_anno_template_type_list_oapg(
