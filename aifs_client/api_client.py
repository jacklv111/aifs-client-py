...
from aifs_client import rest
from aifs_client.configuration import Configuration
from aifs_client.exceptions import ApiTypeError, ApiValueError, ApiException
from aifs_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AnnotationTemplateApi()
        api_instance.copy_annotation_template  # this is an instance of the class Endpoint
        api_instance.copy_annotation_template()  # this invokes api_instance.copy_annotation_template.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.copy_annotation_template.callable or self.callable in this class
