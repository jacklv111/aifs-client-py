...
class UpdateAnnotationTemplateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, name, type, *args, **kwargs):  # noqa: E501
        """UpdateAnnotationTemplateRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): the description of the annotation template. [optional]  # noqa: E501
